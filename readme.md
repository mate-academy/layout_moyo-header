...
- [DEMO LINK](https://Oleksandr-Pustovit.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://Oleksandr-Pustovit.github.io/layout_moyo-header/report/html_report/)
...
## The task
Create HTML page with the header using `flexbox` basing on [this mockup](https://www.npmfigma.com/file/KAV1NnDp7hgQtPnaD6XdOcnG/Moyo-%2F-Header).
