...
- reset browser default margins. v
- use [Roboto font](https://fonts.google.com/specimen/Roboto). v
- use semantic tags: `<header>`, `<img>`, `<nav>`, `<ul>`, `<li>` and `<a>`. v
- the header should stretch the full page width (don't use horizontal margin). v
- the height should be set for nav links (not the header), take it from the design. v
...
- [DEMO LINK](https://VitoorMF.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://VitoorMF.github.io/layout_moyo-header/report/html_report/)
