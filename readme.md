...
Create HTML page with the header using `flexbox` based on the [Figma Mockup](<https://www.figma.com/design/ojkArVazq7vsX0nbpn9CxZ/Moyo-%2F-Catalog-(ENG)?node-id=32278-712&node-type=canvas&t=7ATGFAug8R1XaXAs-0>).
...
- [DEMO LINK](https://mariiatropanets.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://mariiatropanets.github.io/layout_moyo-header/report/html_report/)
