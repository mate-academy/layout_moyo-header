...
- [DEMO LINK](https://Dmytro-Kretov.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://Dmytro-Kretov.github.io/layout_moyo-header/report/html_report/)
...
- [x] var(--blue-color) is used for a blue color
