...
- [DEMO LINK](https://ArturVyklynets.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://ArturVyklynets.github.io/layout_moyo-header/report/html_report/)
...
- [ ] **color-text** is used for a blue color
