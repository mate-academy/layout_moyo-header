...
- header content should be vertically centered.ok
- Logo should also be a link with an image inside (from [src/images](src/images)). But it should not be a part of the `<nav>`.ok
- ❗️ the blue link with a line below should have a class `is-active` in addition to any other classes you add.ok
- ❗️ add `data-qa="hover"` attribute to the 4th link for testing (`Laptops & computers`) ok
- link color should be changed on `:hover` ok
...
- [DEMO LINK](https://MatheusMotaGomes.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://MatheusMotaGomes.github.io/layout_moyo-header/report/html_report/)
