...
- [DEMO LINK](https://d-hubych.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://d-hubych.github.io/layout_moyo-header/report/html_report/)
...
## The task
Create HTML page with the header using `flexbox` basing on [this mockup](https://www.figma.com/file/1sog2rmfyCjnVxkeZ3ptnc/MOYO-).
