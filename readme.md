...
- [DEMO LINK](https://Daniilart01.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://Daniilart01.github.io/layout_moyo-header/report/html_report/)
...
- the link ` with onlyblue` color is an example of `:hover` styles. Every link in the row should have `blue` color on `:hover`.
