...
- [DEMO LINK](https://tillorn.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://tillorn.github.io/layout_moyo-header/report/html_report/)
...
## The task
Create HTML page with the header using `flexbox` basing on [this mockup](https://www.figma.com/file/1sog2rmfyCjnVxkeZ3ptnc/MOYO-%2F-Header?node-id=0%3A1&t=UFPnt4uu6kgoig8J-0).
