# Moyo header
Create HTML page with the header using `flexbox` based on the [Figma Mockup](https://www.figma.com/design/1sog2rmfyCjnVxkeZ3ptnc/MOYO-%2F-Header?node-id=2-14&t=JwA9D5P9aSCTz4hJ-0).
...
- [DEMO LINK](https://iyehorova.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://iyehorova.github.io/layout_moyo-header/report/html_report/)
